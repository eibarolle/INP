...
np.save("data/ypred_testset_%d" % seed, np.array(ypred_testset))
np.save("data/mae_testset_%d" % seed, np.array(mae_testset))
torch.save(dcrnn.state_dict(), "data/lig_seed%d_final.pt" % seed)
